 ...
 *
 * The assertions themselves live in `com.gamesidebar.core.tests.*` against a dependency-free
 * harness; [CoreTestSuites] runs the exact same registry from `main` (see
 * `tools/run_core_tests.sh`) for machines without Gradle. One copy of the logic, two runners.
 */
